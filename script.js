...
const teamBios = {
    ...
    'steve-barone': {
        ...
        photo: 'images/stevebarone.png',
        bio: 'Steve Barone leads talent acquisition efforts for Red Pill Holdings as National Director of Talent Acquisition. His expertise in identifying and recruiting top-tier professionals ensures the organization continues to attract exceptional talent across all divisions and strategic initiatives.'
    },
    'harsukh': {
        name: 'Harsukh Gevariya',
        title: 'Red Pill Medical Inc. Advisory Board',
        photo: 'images/harkush.png',
    ...
    companyLogos.forEach(logo => {
        logo.addEventListener('click', function() {
            ...
            if (url && url !== '#') {
                ...
                alert(`${companyId.toUpperCase()} website link will be added soon.`);
            }
        });
    });
